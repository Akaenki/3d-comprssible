/*
 * ===================================  sfc ===============================
 *   sfc shows 2-d field as a surface and shows the max/min, time & title.
 *
 ...
 * 	title	input	character*	character string for title
 *	name	input	character*	character string with your name
 */
...
void sfc(int nx,int ny,int nyuse,float s[][ny],float simtime,
	 float angh,float angv,char *title,char *name)
{
