...
PROGRAM	= pgm5
OBJECTS = pgm5.o advection.o bc.o ic.o update.o stats.o plot1d.o sfc.o contr.o advect1d.o errors.o diffusion.o pgf.o
SOURCE  = pgm5.c advection.c bc.c ic.c update.c stats.c plot1d.c sfc.c contr.c advect1d.c errors.c diffusion.c pgf.c
ARCHIVE = pgm5.tar
CC	= ncargcc
OPTIONS	= 
